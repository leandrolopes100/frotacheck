...
Checklist Dig       ital Inteligente: Substituição total do papel por formulários dinâmicos e intuitivos.
 ...
 Dashboard de Saúde da Frota: Visão analítica para o gestor identificar rapidamente quais veículos possuem avarias críticas.
 Controle de Acesso (RBAC): Níveis de permissão distintos para Motoristas (vistorias) e Patrões/Admin (relatórios e gestão).

* Tecnologias Utilizadas
Este projeto utiliza uma stack moderna focada em performance e escalabilidade:

Backend: Python & Django 5.x
Frontend: Tailwind CSS (UI Tática/Dark Mode)
Banco de Dados: PostgreSQL (Produção) / SQLite (Desenvolvimento)
Geolocalização: HTML5 Geolocation API
Estilização de Ícones: Font Awesome 6
